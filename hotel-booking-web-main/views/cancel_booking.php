...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .btn-book { position:absolute; left:25px; bottom:25px; right:25px; padding: 15px; background-color: #0F5FF2; color: white; border: none; border-radius: 8px; font-size: 16px; font-weight: bold; cursor: pointer; transition: 0.3s; }
...
<div class="container">
    <div class="booking-box">
        ...
        <div class="right">
            ...
            <form method="post" action="cancel_booking.php?id=<?= $booking['id'] ?>">
                <div class="info-group">
                    <div class="info-label">Lý do hủy:</div>
                    <div><textarea name="reason" required style="width:100%; height:120px; padding:12px; border:1px solid #ccc; border-radius:6px; resize:none;"></textarea></div>
                </div>  
